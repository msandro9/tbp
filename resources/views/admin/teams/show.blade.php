<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-nav-link :href="route('admin.teams.edit', ['team' => $t->id])"
                        :active="request()->routeIs('admin.teams.edit')">
                {{ __('Edit team') }}
            </x-nav-link>
            <x-nav-link>
                                ...
                                @foreach ($employees as $e)
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <x-nav-link
                                                :href="route('admin.employees.show', ['employee' => $e->id])"
                                                :active="request()->routeIs('admin.employees.show')">
                                                {{ __('show') }}
                                            </x-nav-link>
                                        </td>
                                    </tr>
